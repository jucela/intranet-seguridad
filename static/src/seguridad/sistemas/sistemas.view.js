...
var SistemaController = (function () {
    ...
    SistemaController.prototype.getPermisos = function () {
        var _this = this;
    ...
    SistemaController.prototype.setChangeProyectos = function () {
        var _this = this;
    ...
    SistemaController.prototype.setChangeSistemas = function () {
        var _this = this;
    ...
    SistemaController.prototype.getPermisosbyProyectoSistema = function () {
        var _this = this;
    ...
    SistemaController.prototype.getProyectos = function () {
        var _this = this;
    ...
    SistemaController.prototype.addPermiso = function (proyectosistema) {
        var _this = this;
        ...
        if (this.permiso_form_validate.valid()) {
            ...
            this.permisoService.add(valid_form).done(function () {
                ...
                //utils.showDivAlert('El permiso se ha agregado con éxito!...','success');
    ...
    SistemaController.prototype.editPermiso = function (proyectosistema) {
        var _this = this;
        if (proyectosistema === void 0) { proyectosistema = false; }
        if (this.permiso_form_validate.valid()) {
            var valid_form = objectHelper.formToObject(utils.serializeForm('form_permiso'));
    ...
    SistemaController.prototype.setPermiso = function (pk, proyectosistema) {
        if (proyectosistema === void 0) { proyectosistema = false; }
        var data = null;
        if (proyectosistema) {
    ...
    SistemaController.prototype.setProyecto = function (pk) {
        var data = null;
    ...
    SistemaController.prototype.setModal = function (modal_title, data_selected) {
